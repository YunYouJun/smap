...
<template>
  <aside class="route-panel" aria-label="航线规划">
    ...
    <div class="route-panel__inputs" aria-label="出发与到达">
      <div class="route-panel__input-row">
        <span class="route-panel__dot route-panel__dot--origin"></span>
        <span class="route-panel__input-text">地球轨道港</span>
        <button type="button" aria-label="清除出发地">×</button>
      </div>
      <div class="route-panel__connector"></div>
      <div class="route-panel__input-row">
        <span class="route-panel__dot route-panel__dot--destination"></span>
        <span class="route-panel__input-text">火星中继站</span>
        <button type="button" aria-label="清除目的地">×</button>
      </div>
      <button class="route-panel__add-stop" type="button">
